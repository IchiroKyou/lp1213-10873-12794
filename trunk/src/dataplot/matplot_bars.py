...
@obs: Funcao para desenhar um grafico de barras
'''
import sys
...
def desenhaGraphBars(curso_nf):
	'''
	Funcao que desenha um grafico de barras
	'''
	N = 16
	menMeans = curso_nf.totalH
